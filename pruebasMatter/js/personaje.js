...
export function createP()
{
	...
	player=this.matter.add.sprite(400,300,'player');
	...
	arma=this.matter.add.sprite(0,0,'espada');
	arma.visible = false;
	...
	var g = this.matter.world.nextGroup(true);
	player.setCollisionGroup(g);
	var e = this.matter.world.nextGroup(true);
	arma.setCollisionGroup(g);
	arma.setCollisionCategory(2);
