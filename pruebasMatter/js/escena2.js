...
create()
{
	...
	//fl = this.matter.add.sprite(300,400, 'flecha')
	
	
	this.cameras.main.setBounds(0, 0, 800 * 2, 600 * 2);
    this.matter.world.setBounds(0, 0, 800 * 2, 600 * 2);
    
	personaje.createP.call(this);
	console.log(this);
	/*this.matter.add.collider(personaje.player, suelo);
	this.matter.add.collider(personaje.player, objetos);
	this.matter.add.collider(personaje.flechasList, suelo);
	this.matter.add.collider(personaje.flechasList, objetos);*/
	this.matter.world.convertTilemapLayer(suelo);
	this.matter.world.convertTilemapLayer(objetos);
	//mapa.createFromTiles()
