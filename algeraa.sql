...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 13:30:56
...
--
ALTER TABLE `jugadores`
  MODIFY `codigo_jugadores` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `objetos`
--
ALTER TABLE `objetos`
  MODIFY `codigo_objetos` int(11) NOT NULL AUTO_INCREMENT;
