...
export function crearArmadura() {
    ...
    espada=this.physics.add.sprite(0,0,'swordArmadura');
    espada.setOrigin(0.5,0.5);
    espada.setScale(0.4,0.4);
    espada.alpha=0;
    espada.setSize(300,300);
    espada.setCircle(150);
